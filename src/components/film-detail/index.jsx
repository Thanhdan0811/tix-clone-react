...
import "./index.css";
import bgFilm from "../../assests/images/background-films-detail.jpg";
import filmImg from "../../assests/images/film-17.jpg";
import filmStart from "../../assests/images/film-star.png";
import filmStarthalf from "../../assests/images/film-star-half.png";
import userImg from "../../assests/images/user-default-avarta.png";
import listStars from "../../assests/images/listStar.png";
                            ...
                            <div className="film-intro">
                                ...
                                <div className="film-info">
                                    ...
                                    <p className="film-time">
                                        90 phút - 0 IMDb - 2D/Digital
                                    </p>
                                    <button className="btn film-btn">
                                        MUA VÉ
                                    </button>
                                </div>
                            </div>
                ...
                <div className="book-film tix-container">
                    <ul className="nav nav-tabs book-film-navs" role="tablist">
                        <li className="nav-item" role="presentation">
                            <a className="nav-link common-title active" id="home-tab" data-toggle="tab" href="#book-film-showtimes">
                                Lịch Chiếu
                            </a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link common-title" id="profile-tab" data-toggle="tab" href="#book-film-info">
                                Thông tin
                            </a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link common-title" id="contact-tab" data-toggle="tab" href="#book-film-preview">
                                Đánh giá
                            </a>
                        </li>
                    </ul>
                    <div className="tab-content book-film-navs-content" >
                        <div className="tab-pane fade show active" id="book-film-showtimes">
                            <div className="film-showtimes-wrap">
                                <ul className="nav nav-tabs film-showtimes-tabs" id="film-showtimes-tabs">
                                    <li className="nav-item" >
                                        <a className="nav-link showtimes-cinema-item  hover--opacity border--bottom  active" data-toggle="tab" href="#showtimes-cinema-1" >
                                    ...
                                    <li className="nav-item" >
                                        <a className="nav-link showtimes-cinema-item hover--opacity border--bottom " data-toggle="tab" href="#showtimes-cinema-2" >
                                ...
                                <div className="film-showtimes-content-wrap">
                                    ...
                                    <div className="tab-content film-showtimes-content" id="myTabContent">
                                        <div className="tab-pane fade show active" id="showtimes-cinema-1">
                                            {/* film item  */}
                                            ...
                                            {/* film item  */}
                                            <div className="cinema-film-item border--bottom">
                                                <div className="film-collapse"  data-toggle="collapse" data-target="#id-2">
                                                    <img src={cinema1} className="img img--cinema" alt=""/>
                                                    <div className="film-collapse-info">
                                                    <p class="film-name"> <span class="common-age-type">C16</span> Gái Già Lắm Chiêu V - Những Cuộc Đời Vương Giả</p>
                                                    <p className="film-time">
                            ...
                            <div className="book-film-info-wrap row">
                                <div className="info-left col-sm-6">
                                    ...
                                    <div className="row info-left-item">
                                        ...
                                        <div className="info-left-content">Tuấn Trần, Trấn Thành</div>
                                    </div>
                                    {/* end item */}
                                    {/* Item */}
                                    <div className="row info-left-item">
                        ...
                        <div className="tab-pane fade" id="book-film-preview">
                            <div className="film-preview-wrap">
                                <div className="film-preview-user">
                                    <p className="user-think"><img src={userImg} className="img" alt=""/> Bạn nghĩ gì về phim này?</p>
